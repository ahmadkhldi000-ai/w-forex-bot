...
export const INSTRUMENTS: InstrumentSpec[] = [
  { symbol: "EURUSD", name: "Euro / US Dollar",       pip: 0.0001, digits: 5, spreadPips: 0.8, base: 1.0842,  volatility: 0.00035, category: "FX",     binance: "EURUSDT" },
  { symbol: "GBPUSD", name: "British Pound / USD",    pip: 0.0001, digits: 5, spreadPips: 1.1, base: 1.2718,  volatility: 0.00040, category: "FX",     binance: "GBPUSDT" },
  { symbol: "USDJPY", name: "US Dollar / Japanese Yen", pip: 0.01, digits: 3, spreadPips: 0.9, base: 161.42,  volatility: 0.025,   category: "FX",     binance: null },
  { symbol: "XAUUSD", name: "Gold / US Dollar",       pip: 0.01,   digits: 2, spreadPips: 2.5, base: 4110.0,  volatility: 0.45,    category: "Metal",  binance: "PAXGUSDT" },
  { symbol: "BTCUSD", name: "Bitcoin / US Dollar",    pip: 0.1,    digits: 1, spreadPips: 8,   base: 62480,   volatility: 18,      category: "Crypto", binance: "BTCUSDT" },
];

export const DEFAULT_SYMBOL = "EURUSD";

/** Binance interval string for our timeframe ids. */
